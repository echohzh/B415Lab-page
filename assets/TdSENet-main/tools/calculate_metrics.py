...
if __name__ == "__main__":
    ...
    parser.add_argument("-R", "--reference", required=True, type=str, help="/home/dataset/DNS-Challenge/DNS-Challenge/datasets/test_set/synthetic/no_reverb/clean/")
    parser.add_argument("-E", "--estimated", required=True, type=str, help="/home/xyj/Enh_audio/CMGAN-multi/Voicebank/DNS_GTCRN/")
    parser.add_argument(
        "-M",
        "--metric_types",
        required=True,
