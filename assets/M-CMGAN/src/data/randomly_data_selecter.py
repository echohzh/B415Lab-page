...
# 指定音频文件所在目录
audio_directory = '/home/xyj/uyghur/test'
output_directory = '/home/xyj/datasets/U-C-babbleJSON/'
output_file = 'Uclean.json'
...
import random
# 随机选择 400 条音频文件
selected_audio_files = random.sample(all_audio_files, min(100, len(all_audio_files)))
