...
def enhanced1(model_path, noisy_dir, save_tracks, saved_dir,device='cuda:1'):
    ...
    for audio in audio_list:
        ...
        est_audio, length = enhance_one_track(model, noisy_path, saved_dir, 16000*9, n_fft, n_fft//4, save_tracks)
...
parser.add_argument("--model_path", type=str, default='/home/xyj/Experience/CMG-v1/src/tdsenet_Dweight/epoch60-pesq:3.604-loss_sum:0.5140:-g:0.507-d:0.006',
                    help="the path where the model is saved")
...
parser.add_argument("--test_dir", type=str, default='/home/dataset/Voicebank/noisy-vctk-16k',
                    help="noisy tracks dir to be enhanced")
parser.add_argument("--save_tracks", type=str, default=True, help="save predicted tracks or not")
parser.add_argument("--save_dir", type=str, default='../Enh_audio_CMGAN', help="where enhanced tracks to be saved")
args = parser.parse_args()


if __name__ == '__main__':

    # noisy_dir = os.path.join(args.test_dir, 'baiqiang')
