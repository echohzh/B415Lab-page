...
def enhance_one_track(model, audio_path, saved_dir, cut_len, n_fft=400, hop=100, save_tracks=False,device='cuda:1'):
    ...
    # 将 numpy array 转换为 torch tensor，并添加通道维度
    # librosa 返回的是一维数组（单声道），需要转换为 [channels, samples] 格式
    noisy = torch.from_numpy(audio_array).float().unsqueeze(0)  # 添加通道维度
...
parser.add_argument("--model_path", type=str, default='/home/xyj/Experiments/CMG-v1/epoch47-pesq:2.969-loss_sum:0.0875:-g:0.082-d:0.004',
...
#                     help="the path where the model is saved")
# parser.add_argument("--test_dir", type=str, default='/home/xyj/datasets/english/vb_Lsnr/',
parser.add_argument("--test_dir", type=str, default='/home/xyj/极嘈杂语音/split_clwdwbl/',
                    help="noisy tracks dir to be enhanced")
parser.add_argument("--save_tracks", type=str, default=True, help="save predicted tracks or not")
parser.add_argument("--save_dir", type=str, default='/home/xyj/极嘈杂语音增强结果/Td-SENet/split_clwdwbl', help="where enhanced tracks to be saved")
...
if __name__ == '__main__':
    ...
    # clean_dir = os.path.join(args.test_dir, 'test')
...
#
# #     # #得到增强算法1的评价指标
#         sisnr_evaluation(noisy_dir=noisy_dir, clean_dir = '/home/xyj/datasets/DNS-30h/test',
