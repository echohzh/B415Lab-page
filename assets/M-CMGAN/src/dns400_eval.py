...
# parser.add_argument("--model_path", type=str, default='/home/xyj/Experience/epoch44-pesq:3.101-loss_sum:0.6040:-g:0.565-d:0.038',
...
# parser.add_argument("--save_dir", type=str, default='../Enh_audio-C2td_', help="where enhanced tracks to be saved")
...
parser.add_argument("--test_dir", type=str, default='/home/xyj/datasets/chinese/dev_noisy_db/',
                    help="noisy tracks dir to be enhanced")
parser.add_argument("--save_tracks", type=str, default=True, help="save predicted tracks or not")
parser.add_argument("--save_dir", type=str, default='../Enh_audio-cmgan_chineseDNS400', help="where enhanced tracks to be saved")
args = parser.parse_args()
